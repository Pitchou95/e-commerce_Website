...
const Footer = () => {
  return (
    <div className="footer-background footer mt-3 py-3" style={{ maxHeight: "50px" }}>
      <Container className="">
        <Row className="d-flex justify-content-between align-items-center">
          <Col sm="6" className="d-flex align-items-center ">
            <div className="footer-shroot ">Terms and Condition</div>
          ...
          <Col
            ...
            <div className="d-flex pt-3 mx-2">
              ...
              <p className="footer-phone">0648731151</p>
            </div>
